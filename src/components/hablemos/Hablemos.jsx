  ...
  return (
    <div className='containerHablemos' id="SectionHablemos">
        ...
        <div className='rigthHablemos'>
            ...
            <p className='bodyHablemos'>Cada mes que pasas sin revisar tu factura de servicios públicos es una oportunidad de ahorro que se pierde. No lo pienses más y empieza a ahorrar con <span className='SagyTitleHablemos'>Sagy</span>.</p>
